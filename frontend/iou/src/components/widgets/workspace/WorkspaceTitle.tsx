...
export default function WorkspaceTitle() {
  ...
  return (
    <Input
      className="h-8 flex-grow font-medium text-left align-middle border-none shadow-none pointer-events-auto px-0 focus-visible:px-1.5 transition-[padding] w-96 text-shadow-sm"
